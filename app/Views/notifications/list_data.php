                ...
                <div class="d-flex text-wrap">
                    ...
                    <div class="w100p">
                        <div class="mb5">
                            ...
                            <span class="text-off float-end"><small><?php echo format_to_relative_time_2($notification->created_at, false, false);?></small></span>
                        </div>
                            ...
                            document.addEventListener("DOMContentLoaded", () => {
                                ...
                                notifyItems.forEach(item => {
                                    ...
                                    if (id) {
                                        ...
                                        if (parent) {
                                            parent.setAttribute("href", `daily_report?report=${id}`);
                                        }
                                    }
                                });
                            });
