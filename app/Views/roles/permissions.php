    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <ul class="permission-list">
                <li>
                    ...
                    <div id="project_permission_details_area" class="form-group <?php echo $do_not_show_projects ? "hide" : ""; ?>">
                        ...
                        <div id="individual_project_permission_area" class="<?php echo $can_manage_all_projects ? "hide" : ""; ?>">
                            ...
                            <div>
                                <?php
                                echo form_checkbox("bills_project_permission", "1", $bills_project_permission ? true : false, "id='bills_project_permission' class='manage_project_section form-check-input'");
                                ?>
                                <label for="bills_project_permission"><?php echo app_lang("can_access_bills_project"); ?></label>
                            </div>
                ...
                <?php if(get_setting("module_price")) { ?> <!----Modulo de Precio  can_manage_all_kinds_of_settings----->
                    <li>
                        <span data-feather="key" class="icon-14 ml-20"></span>
                        <h5><?php echo app_lang("can_access_price"); ?></h5>
                        <div>
                            <?php
                            echo form_checkbox("can_see_price_list", "1", $can_see_price_list ? true : false, "id='can_see_price_list' class='form-check-input'");
                            ?>
                            <label for="can_see_price_list"><?php echo app_lang("can_see_price_list"); ?></label>
                        </div>
                        <div>
                            <?php
                            echo form_checkbox("can_create_price_list", "1", $can_create_price_list ? true : false, "id='can_create_price_list' class='form-check-input'");
                            ?>
                            <label for="can_create_price_list"><?php echo app_lang("can_create_price_list"); ?></label>
                        </div>
                    </li>
                ...
                <li>
                    <span data-feather="key" class="icon-14 ml-20"></span>
                    <h5><?php echo app_lang("can_access_deposit_report"); ?> <span class="help" data-bs-toggle="tooltip" title="Hides all information of clients except company name."><i data-feather="help-circle" class="icon-14"></i></span></h5>
                    <div>
                        <?php
                        if (is_null($deposit)) {
                            $deposit = "";
                        ...
                        echo form_radio(array(
                            "id" => "deposit_no",
                            "name" => "deposit_permission",
                            "value" => "",
                            "class" => "deposit_permission toggle_specific form-check-input",
                        ), $deposit, ($deposit === "") ? true : false);
                        ?>
                        <label for="deposit_no"><?php echo app_lang("no"); ?> </label>
                    </div>
                    <div>
                        <?php
                        echo form_radio(array(
                            ...
                            "value" => "view",
                            "class" => "deposit_permission toggle_specific form-check-input",
                        ), $deposit, ($deposit === "view") ? true : false);
                        ?>
                        <label for="deposit_view"><?php echo app_lang("permission_deposit_report_view"); ?></label>
                    </div>
                    <div>
                        <?php
                        echo form_radio(array(
                            ...
                            "value" => "create",
                            "class" => "deposit_permission toggle_specific form-check-input",
                        ), $deposit, ($deposit === "create") ? true : false);
                        ?>
                        <label for="deposit_create"><?php echo app_lang("permission_deposit_report_create"); ?></label>
                    </div>
                    <div>
                        <?php
                        echo form_radio(array(
                            ...
                            "value" => "all",
                            "class" => "deposit_permission toggle_specific form-check-input",
                        ), $deposit, ($deposit === "all") ? true : false);
                        ?>
                        <label for="deposit_all"><?php echo app_lang("permission_deposit_report_admin"); ?></label>
                    </div>
                </li>
                ...
                <?php if (get_setting("module_credit_card")) { ?>
                    <li>
                        <span data-feather="key" class="icon-14 ml-20"></span>
                        <h5><?php echo app_lang("can_access_credit_card"); ?></h5>
                        <div>
                            <?php
                            ...
                            echo form_radio(array(
                                "id" => "credit_card_permission_no",
                                "name" => "credit_card_permission",
                                "value" => "",
                                "class" => "ticket_permission toggle_specific form-check-input",
                            ), $credit_card, ($credit_card === "") ? true : false);
                            ?>
                            <label for="credit_card_permission_no"><?php echo app_lang("no"); ?> </label>
                        </div>
                        <div>
                            <?php
                            echo form_radio(array(
                                "id" => "credit_card_permission_admin",
                                "name" => "credit_card_permission",
                                "value" => "admin",
                                "class" => "ticket_permission toggle_specific form-check-input",
                            ), $credit_card, ($credit_card === "admin") ? true : false);
                            ?>
                            <label for="credit_card_permission_admin"><?php echo app_lang("admin_text_admin"); ?></label>
                        </div>
                        <div>
                            <?php
                            echo form_radio(array(
                                "id" => "credit_card_permission_counter",
                                "name" => "credit_card_permission",
                                "value" => "counter",
                                "class" => "ticket_permission toggle_specific form-check-input",
                            ), $credit_card, ($credit_card === "counter") ? true : false);
                            ?>
                            <label for="credit_card_permission_counter"><?php echo app_lang("admin_text_accountant"); ?></label>
                        </div>
                        <div class="form-group">
                            <?php
                            echo form_radio(array(
                                "id" => "credit_card_permission_manager",
                                "name" => "credit_card_permission",
                                "value" => "manager",
                                "class" => "ticket_permission toggle_specific form-check-input",
                            ), $credit_card, ($credit_card === "manager") ? true : false);
                            ?>
                            <label for="credit_card_permission_manager"><?php echo app_lang("admin_text_manager"); ?></label>
                        </div>
                    </li>
                <?php } ?>
                ...
                <?php if (get_setting("module_daily")) { ?>
                    <li>
                        <span data-feather="key" class="icon-14 ml-20"></span>
                        <h5><?php echo app_lang("can_access_report_daily"); ?></h5>
                        <div>
                            <?php
                            if (is_null($daily_permission)) {
                                $daily_permission = "";
                            }
                            echo form_radio(array(
                                "id" => "daily_permission_no",
                                "name" => "daily_permission",
                                "value" => "",
                                "class" => "daily_permission toggle_specific form-check-input",
                            ), $daily_permission, ($daily_permission === "") ? true : false);
                            ?>
                            <label for="daily_permission_no"><?php echo app_lang("no"); ?> </label>
                        </div>
                        <div>
                            <?php
                            echo form_radio(array(
                                ...
                                "value" => "create",
                                "class" => "ticket_permission toggle_specific form-check-input",
                            ), $daily_permission, ($daily_permission === "create") ? true : false);
                            ?>
                            <label for="credit_card_permission_admin"><?php echo app_lang("only_create"); ?></label>
                        </div>
                        <div>
                            <?php
                            echo form_radio(array(
                                ...
                                "value" => "all",
                                "class" => "ticket_permission toggle_specific form-check-input",
                            ), $daily_permission, ($daily_permission === "all") ? true : false);
                            ?>
                            <label for="credit_card_permission_counter"><?php echo app_lang("can_admin"); ?></label>
                        </div>
                ...
                <?php if (get_setting("module_directory")) { ?>
                    <li>
                        <span data-feather="key" class="icon-14 ml-20"></span>
                        <h5><?php echo app_lang("can_access_directory_clinic"); ?></h5>
                        <div>
                            <?php
                            if (is_null($directory_permission)) {
                                $directory_permission = "";
                            }
                            echo form_radio(array(
                                "id" => "directory_permission_no",
                                "name" => "directory_permission",
                                "value" => "",
                                "class" => "directory_permission toggle_specific form-check-input",
                            ), $directory_permission, ($directory_permission === "") ? true : false);
                            ?>
                            <label for="directory_permission_no"><?php echo app_lang("no"); ?> </label>
                        </div>
                        <div>
                            <?php
                            echo form_radio(array(
                                "id" => "directory_permission_view",
                                "name" => "directory_permission",
                                "value" => "view",
                                "class" => "ticket_permission toggle_specific form-check-input",
                            ), $directory_permission, ($directory_permission === "view") ? true : false);
                            ?>
                            <label for="directory_permission_view"><?php echo app_lang("only_view"); ?></label>
                        </div>
                        <div>
                            <?php
                            echo form_radio(array(
                                "id" => "directory_permission_admin",
                                "name" => "directory_permission",
                                "value" => "all",
                                "class" => "ticket_permission toggle_specific form-check-input",
                            ), $directory_permission, ($directory_permission === "all") ? true : false);
                            ?>
                            <label for="directory_permission_admin"><?php echo app_lang("can_admin"); ?></label>
                        </div>
                ...
                <?php if (get_setting("module_clockin")) { ?>
                    <li>
                        <span data-feather="key" class="icon-14 ml-20"></span>
                        <h5><?php echo app_lang("can_access_clock"); ?></h5>
                        <div>
                            <?php
                            if (is_null($clock)) {
                                $clock = "";
                            ...
                            echo form_radio(array(
                                "id" => "clock_no",
                                "name" => "clock_permission",
                                "value" => "",
                                "class" => "form-check-input",
                            ), $clock, ($clock === "") ? true : false);
                            ?>
                            <label for="clock_no"><?php echo app_lang("no"); ?> </label>
                        </div>
                        <div>
                            <?php
                            echo form_radio(array(
                                ...
                                "value" => "own",
                                "class" => "form-check-input",
                            ), $clock, ($clock === "own") ? true : false);
                            ?>
                            <label for="clock_own">Si puede ver su marcaje</label>
                        </div>
                        <div>
                            <?php
                            echo form_radio(array(
                                ...
                                "value" => "clinic",
                                "class" => "form-check-input",
                            ), $clock, ($clock === "clinic") ? true : false);
                            ?>
                            <label for="clock_clinic">Si puede ver por clínicas</label>
                        </div>
                        <div>
                            <?php
                            echo form_radio(array(
                                ...
                                "value" => "admin",
                                "class" => "form-check-input",
                            ), $clock, ($clock === "admin") ? true : false);
                            ?>
                            <label for="clock_admin">Si puede administrar</label>
                        </div>
                    </li>
                <?php } ?>

                <?php if (get_setting("module_camera")) { ?>
                    <li>
                        <span data-feather="key" class="icon-14 ml-20"></span>
                        <h5><?php echo app_lang("can_access_camera"); ?></h5>
                        <div>
                            <?php
                            if (is_null($camera)) {
                                $camera = "";
                            ...
                            ?>
                            <label for="camera_no"><?php echo app_lang("no"); ?> </label>
                        </div>
                        <div>
                            <?php
                            echo form_radio(array(
                                ...
                                "value" => "all",
                                "class" => "form-check-input",
                            ), $camera, ($camera === "all") ? true : false);
                            ?>
                            <label for="camera_yes"><?php echo app_lang("yes"); ?></label>
                        </div>
                    </li>
                <?php } ?>

                <?php if (get_setting("module_excuse")) { ?>
                    <li>
                        <span data-feather="key" class="icon-14 ml-20"></span>
                        <h5><?php echo app_lang("can_access_excuse"); ?></h5>
                        <div>
                            <?php
                            if (is_null($excuse_permission)) {
                                $excuse_permission = "";
                            }
                            echo form_radio(array(
                                "id" => "excuse_no",
                                "name" => "excuse_permission",
                                "value" => "",
                                "class" => "form-check-input",
                            ), $excuse_permission, ($excuse_permission === "") ? true : false);
                            ?>
                            <label for="excuse_no"><?php echo app_lang("no"); ?> </label>
                        </div>
                        <div>
                            <?php
                            echo form_radio(array(
                                ...
                                "value" => "all",
                                "class" => "form-check-input",
                            ), $excuse_permission, ($excuse_permission === "all") ? true : false);
                            ?>
                            <label for="excuse_yes"><?php echo app_lang("can_access_excuse_admon"); ?></label>
                        </div>

                        <div>
                            <?php
                            echo form_radio(array(
                                "id" => "excuse_yes_request",
                                "name" => "excuse_permission",
                                "value" => "provider",
                                "class" => "form-check-input",
                            ), $excuse_permission, ($excuse_permission === "provider") ? true : false);
                            ?>
                            <label for="excuse_yes_request"><?php echo app_lang("can_access_excuse_providers"); ?></label>
                        </div>
                        ...
                        <div>
                            ...
                            echo form_radio(array(
                                ...
                                "value" => "request",
                                "class" => "form-check-input",
                            ), $excuse_permission, ($excuse_permission === "request") ? true : false);
                            ?>
                            <label for="excuse_yes_request"><?php echo app_lang("can_access_excuse_request"); ?></label>
                        </div>
                    </li>
                <?php } ?>
                ...
                <?php if (get_setting("module_event")) { ?>
                    <li>
                        <span data-feather="key" class="icon-14 ml-20"></span>
                        <h5><?php echo app_lang("can_access_event"); ?></h5>
                        <div>
                            <?php
                            ...
                            echo form_radio(array(
                                "id" => "event_permission_no",
                                "name" => "event_permission",
                                "value" => "",
                                "class" => "form-check-input",
                            ), $event_permission, ($event_permission === "") ? true : false);
                            ?>
                            <label for="event_permission_no"><?php echo app_lang("no"); ?> </label>
                        </div>
                        <div>
                            <?php
                            echo form_radio(array(
                                "id" => "event_permission_yes",
                                "name" => "event_permission",
                                "value" => "all",
                                "class" => "form-check-input",
                            ), $event_permission, ($event_permission === "all") ? true : false);
                            ?>
                            <label for="event_permission_yes"><?php echo app_lang("yes"); ?></label>
                        </div>
                    </li>
                <?php } ?>

                <?php if (get_setting("module_home_service")) { ?>
                    <li>
                        <span data-feather="key" class="icon-14 ml-20"></span>
                        <h5><?php echo app_lang("can_access_home_service_permission"); ?></h5>
                        <div>
                            <?php
                            if (is_null($home_service_permission)) {
                                $home_service_permission = "";
                            }
                            echo form_radio(array(
                                "id" => "home_service_permission_no",
                                "name" => "home_service_permission",
                                "value" => "",
                                "class" => "form-check-input",
                            ), $home_service_permission, ($home_service_permission === "") ? true : false);
                            ?>
                            <label for="home_service_permission_no"><?php echo app_lang("no"); ?> </label>
                        </div>
                        <div>
                            <?php
                            echo form_radio(array(
                                "id" => "home_service_permission_yes",
                                "name" => "home_service_permission",
                                "value" => "all",
                                "class" => "form-check-input",
                            ), $home_service_permission, ($home_service_permission === "all") ? true : false);
                            ?>
                            <label for="home_service_permission_yes"><?php echo app_lang("yes"); ?></label>
                        </div>
                    </li>
                <?php } ?>

                <?php if (get_setting("module_task")) { ?>
                    <li>
                        <span data-feather="key" class="icon-14 ml-20"></span>
                        <h5><?php echo app_lang("can_access_task"); ?></h5>
                        <div>
                            <?php
                            if (is_null($task_permission)) {
                                $task_permission = "";
                            }
                            echo form_radio(array(
                                "id" => "task_permission_no",
                                "name" => "task_permission",
                                "value" => "",
                                "class" => "form-check-input",
                            ), $task_permission, ($task_permission === "") ? true : false);
                            ?>
                            <label for="task_permission_no"><?php echo app_lang("no"); ?> </label>
                        </div>
                        <div>
                            <?php
                            echo form_radio(array(
                                "id" => "task_permission_yes",
                                "name" => "task_permission",
                                "value" => "all",
                                "class" => "form-check-input",
                            ), $task_permission, ($task_permission === "all") ? true : false);
                            ?>
                            <label for="task_permission_yes"><?php echo app_lang("yes"); ?></label>
                        </div>
                    </li>
                <?php } ?>

                <?php if (get_setting("module_note")) { ?>
                    <li>
                        <span data-feather="key" class="icon-14 ml-20"></span>
                        <h5><?php echo app_lang("can_access_note"); ?></h5>
                        <div>
                            <?php
                            if (is_null($note_permission)) {
                                $note_permission = "";
                            }
                            echo form_radio(array(
                                "id" => "note_permission_no",
                                "name" => "note_permission",
                                "value" => "",
                                "class" => "form-check-input",
                            ), $note_permission, ($note_permission === "") ? true : false);
                            ?>
                            <label for="note_permission_no"><?php echo app_lang("no"); ?> </label>
                        </div>
                        <div>
                            <?php
                            echo form_radio(array(
                                "id" => "note_permission_yes",
                                "name" => "note_permission",
                                "value" => "all",
                                "class" => "form-check-input",
                            ), $note_permission, ($note_permission === "all") ? true : false);
                            ?>
                            <label for="note_permission_yes"><?php echo app_lang("yes"); ?></label>
                        </div>
                    </li>
                <?php } ?>

                <?php if (get_setting("module_team")) { ?>
                    <li>
                        <span data-feather="key" class="icon-14 ml-20"></span>
                        <h5><?php echo app_lang("can_access_team"); ?></h5>
                        <div>
                            <?php
                            if (is_null($team_permission)) {
                                $team_permission = "";
                            }
                            echo form_radio(array(
                                "id" => "team_permission_no",
                                "name" => "team_permission",
                                "value" => "",
                                "class" => "form-check-input",
                            ), $team_permission, ($team_permission === "") ? true : false);
                            ?>
                            <label for="team_permission_no"><?php echo app_lang("no"); ?> </label>
                        </div>
                        <div>
                            <?php
                            echo form_radio(array(
                                "id" => "team_permission_yes",
                                "name" => "team_permission",
                                "value" => "all",
                                "class" => "form-check-input",
                            ), $team_permission, ($team_permission === "all") ? true : false);
                            ?>
                            <label for="team_permission_yes"><?php echo app_lang("yes"); ?></label>
                        </div>
                    </li>
                <?php } ?>
                ...
                <?php if (get_setting("module_report")) { ?>
                    <li>
                        <span data-feather="key" class="icon-14 ml-20"></span>
                        <h5><?php echo app_lang("can_access_report"); ?></h5>
                        <div>
                            <?php
                            if (is_null($report_permission)) {
                                $report_permission = "";
                            }
                            echo form_radio(array(
                                "id" => "report_permission_no",
                                "name" => "report_permission",
                                "value" => "",
                                "class" => "form-check-input",
                            ), $report_permission, ($report_permission === "") ? true : false);
                            ?>
                            <label for="report_permission_no"><?php echo app_lang("no"); ?> </label>
                        </div>
                        <div>
                            <?php
                            echo form_radio(array(
                                "id" => "report_permission_yes",
                                "name" => "report_permission",
                                "value" => "all",
                                "class" => "form-check-input",
                            ), $report_permission, ($report_permission === "all") ? true : false);
                            ?>
                            <label for="report_permission_yes"><?php echo app_lang("yes"); ?></label>
                        </div>
                    </li>
                <?php } ?>

                  <?php if (get_setting("module_vsee")) { ?>
                    <li>
                        <span data-feather="key" class="icon-14 ml-20"></span>
                        <h5><?php echo app_lang("can_access_vsee"); ?></h5>
                        <div>
                            <?php
                            if (is_null($vsee_permission)) {
                                $vsee_permission = "";
                            }
                            echo form_radio(array(
                                "id" => "report_permission_no",
                                "name" => "vsee_permission",
                                "value" => "",
                                "class" => "form-check-input",
                            ), $vsee_permission, ($vsee_permission === "") ? true : false);
                            ?>
                            <label for="vsee_permission_no"><?php echo app_lang("no"); ?> </label>
                        </div>
                        <div>
                            <?php
                            echo form_radio(array(
                                "id" => "vsee_permission_yes",
                                "name" => "vsee_permission",
                                "value" => "all",
                                "class" => "form-check-input",
                            ), $vsee_permission, ($vsee_permission === "all") ? true : false);
                            ?>
                            <label for="vsee_permission_yes"><?php echo app_lang("yes"); ?></label>
                        </div>
                    </li>
                <?php } ?>

                <?php if (get_setting("module_stamp")) { ?>
                    <li>
                        <span data-feather="key" class="icon-14 ml-20"></span>
                        <h5><?php echo app_lang("can_access_stamp"); ?></h5>
                        <div>
                            <?php
                            if (is_null($stamp_permission)) {
                                $stamp_permission = "";
                            }
                            echo form_radio(array(
                                "id" => "stamp_no",
                                "name" => "stamp_permission",
                                "value" => "",
                                "class" => "form-check-input",
                            ), $stamp_permission, ($stamp_permission === "") ? true : false);
                            ?>
                            <label for="stamp_no"><?php echo app_lang("no"); ?> </label>
                        </div>
                        <div>
                            <?php
                            echo form_radio(array(
                                ...
                                "value" => "all",
                                "class" => "form-check-input",
                            ), $stamp_permission, ($stamp_permission === "all") ? true : false);
                            ?>
                            <label for="stamp_yes"><?php echo app_lang("can_access_excuse_admon"); ?></label>
                        </div>

                        <div>
                            <?php
                            echo form_radio(array(
                                "id" => "stamp_yes_request",
                                "name" => "stamp_permission",
                                "value" => "provider",
                                "class" => "form-check-input",
                            ), $stamp_permission, ($stamp_permission === "provider") ? true : false);
                            ?>
                            <label for="stamp_yes_request"><?php echo app_lang("can_access_excuse_providers"); ?></label>
                        </div>

                        <div>
                            <?php
                            echo form_radio(array(
                                "id" => "stamp_yes_request_all",
                                "name" => "stamp_permission",
                                "value" => "request",
                                "class" => "form-check-input",
                            ), $stamp_permission, ($stamp_permission === "request") ? true : false);
                            ?>
                            <label for="stamp_yes_request_all"><?php echo app_lang("can_access_stamp_request"); ?></label>
                        </div>
                ...
                <?php if (get_setting("module_stamp")) { ?>
                    <li>
                        <span data-feather="key" class="icon-14 ml-20"></span>
                        <h5><?php echo app_lang("can_access_stamp_v1"); ?></h5>
                        <div>
                            <?php
                            if (is_null($stamp_permission_v1)) {
                                $stamp_permission_v1 = "";
                            }
                            echo form_radio(array(
                                "id" => "stamp_no",
                                "name" => "stamp_permission_v1",
                                "value" => "",
                                "class" => "form-check-input",
                            ), $stamp_permission_v1, ($stamp_permission_v1 === "") ? true : false);
                            ?>
                            <label for="stamp_no"><?php echo app_lang("no"); ?> </label>
                        </div>
                        <div>
                            ...
                            echo form_radio(array(
                                ...
                                "value" => "all",
                                "class" => "form-check-input",
                            ), $stamp_permission_v1, ($stamp_permission_v1 === "all") ? true : false);
                            ?>
                            <label for="stamp_yes"><?php echo app_lang("can_access_excuse_admon"); ?></label>
                        </div>
                        ...
                        <div>
                            ...
                            echo form_radio(array(
                                ...
                                "value" => "provider",
                                "class" => "form-check-input",
                            ), $stamp_permission_v1, ($stamp_permission_v1 === "provider") ? true : false);
                            ?>
                            <label for="stamp_yes_request"><?php echo app_lang("can_access_excuse_providers"); ?></label>
                        </div>
                        ...
                        <div>
                            ...
                            echo form_radio(array(
                                ...
                                "value" => "request",
                                "class" => "form-check-input",
                            ), $stamp_permission_v1, ($stamp_permission_v1 === "request") ? true : false);
                            ?>
                            <label for="stamp_yes_request_all"><?php echo app_lang("can_access_stamp_request"); ?></label>
                        </div>
                ...
                <?php if (get_setting("module_file")) { ?>
                    <li>
                        <span data-feather="key" class="icon-14 ml-20"></span>
                        <h5><?php echo app_lang("can_access_file"); ?></h5>
                        <div>
                            <?php
                            if (is_null($file_permission)) {
                                $file_permission = "";
                            }
                            echo form_radio(array(
                                "id" => "file_permission_no",
                                "name" => "file_permission",
                                "value" => "",
                                "class" => "form-check-input",
                            ), $file_permission, ($file_permission === "") ? true : false);
                            ?>
                            <label for="file_permission_no"><?php echo app_lang("no"); ?> </label>
                        </div>
                        <div>
                            <?php
                            echo form_radio(array(
                                "id" => "file_permission_yes",
                                "name" => "file_permission",
                                "value" => "all",
                                "class" => "form-check-input",
                            ), $file_permission, ($file_permission === "all") ? true : false);
                            ?>
                            <label for="file_permission_yes"><?php echo app_lang("yes"); ?></label>
                        </div>
                    </li>
                <?php } ?>


                <?php if (get_setting("module_pending")) { ?>
                    <li>
                        <span data-feather="key" class="icon-14 ml-20"></span>
                        <h5><?php echo app_lang("can_access_pending"); ?></h5>
                        <div>
                            <?php
                            if (is_null($pending_permission)) {
                                $pending_permission = "";
                            }
                            echo form_radio(array(
                                "id" => "pending_permission_no",
                                "name" => "pending_permission",
                                "value" => "",
                                "class" => "form-check-input",
                            ), $pending_permission, ($pending_permission === "") ? true : false);
                            ?>
                            <label for="pending_permission_no"><?php echo app_lang("no"); ?> </label>
                        </div>
                        <div>
                            <?php
                            echo form_radio(array(
                                "id" => "pending_permission_yes",
                                "name" => "pending_permission",
                                "value" => "all",
                                "class" => "form-check-input",
                            ), $pending_permission, ($pending_permission === "all") ? true : false);
                            ?>
                            <label for="pending_permission_yes"><?php echo app_lang("yes"); ?></label>
                        </div>
                    </li>
                <?php } ?>
