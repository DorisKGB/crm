<div id="kanban-wrapper" >
    <ul id="kanban-container"  class="kanban-container clearfix">
        ...
        <?php foreach ($columns as $column) { ?>
            <li style="border: 1px dashed #ddd;border-radius:15px;" class="kanban-col kanban-<?php
            echo $column->id;
            ...
            ?>" >
                ...
                <div class="kanban-col-title" style="color:<?php echo $column->color ? $column->color : "#2e4053"; ?>;background: <?php echo $column->color ? $column->color . '30' : '#2e405380'; ?>;border-bottom: 3px solid <?php echo $column->color ? $column->color : "#2e4053"; ?>;"> <?php echo $column->key_name ? app_lang($column->key_name) : $column->title; ?> <span style="background-color: #fffff" class="kanban-item-count p-1 <?php echo $column->id; ?>-task-count float-end"><?php echo $tasks_count; ?> </span></div>
