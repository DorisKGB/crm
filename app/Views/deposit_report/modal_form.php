<?php echo form_open(get_uri("deposit_report/saveReport"), array("id" => "deposit_report-form", "class" => "general-form", "role" => "form")); ?>
  ...
  <div class="container-fluid">
    ...
    <div class="modal-body clearfix">
      <div class="container-fluid">
        ...
        <?php echo view("deposit_report/deposit_report_form_fields"); ?>
      </div>
    </div>
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
    ...
    if(fileName) {
      // Mostrar el botón si hay un archivo
    if ($('#signature').hasClass('d-none')) {
        // El elemento tiene la clase d-none
        console.log("El elemento tiene la clase d-none");
    } else {
      $("#saveButton").show();
        // El elemento no tiene la clase d-none
        console.log("El elemento NO tiene la clase d-none");
    }
  ...
  document.getElementById('report_date1').addEventListener('change', function() {
    var data = document.getElementById("report_date1").value;
    document.getElementById("report_date_new1").value = formatDateToISO(data);
  });

  /*document.getElementById('clinic_id').addEventListener('change',function(){
    var clinic_name = this.textContent;
    console.log(clinic_name);
    document.getElementById("clinic_name").value = clinic_name;
  });*/ 
</script>