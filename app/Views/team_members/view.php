...
<div id="page-content" class="clearfix">
    ...
    <ul id="team-member-view-tabs" data-bs-toggle="ajax-tab" class="nav nav-tabs scrollable-tabs rounded-0" role="tablist">
        ...
        <?php if ($login_user->is_admin) { ?>
            <li><a  role="presentation" data-bs-toggle="tab" href="<?php echo_uri("team_members/branch/" . $user_info->id); ?>" data-bs-target="#tab-branch"> <?php echo app_lang('branches'); ?></a></li>
            
            <li><a  role="presentation" data-bs-toggle="tab" href="<?php echo_uri("team_members/videocall/" . $user_info->id); ?>" data-bs-target="#tab-video"> <?php echo app_lang('video_call'); ?></a></li>
        <?php } ?>

        <?php if ($show_general_info) { ?>
            <li><a  role="presentation" data-bs-toggle="tab" href="<?php echo_uri("team_members/provider/" . $user_info->id); ?>" data-bs-target="#tab-provider"> <?php echo app_lang('provider'); ?></a></li>
        <?php } ?>
    ...
    <div class="tab-content">
        ...
        <div role="tabpanel" class="tab-pane fade" id="tab-branch"></div>
        <div role="tabpanel" class="tab-pane fade" id="tab-video"></div>
        <div role="tabpanel" class="tab-pane fade" id="tab-provider"></div>
        <?php
        foreach ($hook_tabs as $hook_tab) {
            ?>
