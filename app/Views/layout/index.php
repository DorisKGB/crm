...
<html lang="en" dir="<?php echo $dir; ?>">
    ...
    <body class="<?php echo $left_menu_minimized ? "sidebar-toggled" : ""; ?>">
        ...
        <?php echo view('includes/global_chat_auto_include'); ?>
        <audio id="notif-sound" src="<?= base_url('assets/sounds/excusa.mp3') ?>" preload="auto"></audio>
        <?php echo view('includes/global_excuse_auto_include'); ?>
