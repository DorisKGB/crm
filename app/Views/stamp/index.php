...
<div id="page-content" class="page-wrapper clearfix grid-button">
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-header ">
                    <h4><i class="fas fa-signature"></i> Lista de Timbres</h4>
                </div>
                <div class="card-body" id="list-stamp">
                    <div class="listStamp">
                        ...
                        <!-- NAV DE ESTADOS -->
                        <ul class="nav nav-tabs mb-3" id="stampStatusTabs">
                            <li class="nav-item">
                                <a class="nav-link active" href="#" data-status="pending">Pendientes</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="#" data-status="approved">Aprobadas</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="#" data-status="denied">Negadas</a>
                            </li>
                        </ul>
            ...
            <div class="modal-content p-4">
                <div class="modal-header">
                    <h5 class="modal-title" id="printerInstructionsLabel">
                       <span style="font-weight: 400;"> <i class="fas fa-check-double"></i> Departamento de Tecnología Rubymed </span> <br>
                        <b>Instrucciones de Impresión</b></h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Cerrar"></button>
                </div>
                <div class="modal-body">
    ...
    <div class="modal fade" id="printerConfirmModal" tabindex="-1" aria-labelledby="printerConfirmLabel"
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content p-4 text-center">
                ...
                <div class="modal-body">
                    <img width="50%" style="border-radius: 20px;" src="<?php echo base_url("assets/images/firma_rubymed.png"); ?>" alt="">
    ...
    <audio id="notif-sound" src="<?= base_url('assets/sounds/campana.mp3') ?>" preload="auto"></audio>
...
async function loadStamp() {
    try {
        ...
        if (data.success && data.stamp.length > 0) {
            document.querySelector("#list-stamp .cards-container").innerHTML = "";
            allStamps = data.stamp;
            renderFilteredStamps();
            /*data.stamp.forEach(stamp => {
...
async function mostrarDescripcionTimbre(token) {
    try {
        ...
        if (stamp.template_image) {
            templateImageHTML = `<div style="text-align:center; margin-bottom:10px;">
                                    <img src="${stamp.template_image}" alt="Plantilla" style="width:100%; max-height:300px; object-fit:contain;" class="zoomable">
                                  </div>`;
        }
        const html = `
            ${templateImageHTML}
