        ...
        <div class="card-header">
            <div class="card-title d-flex align-items-center">
                <div class="text-center flex-grow-1">
                    <h3>
                        Vsee <button class="btn-button btn-button-light"><i class="fas fa-sync-alt"></i> Sincronizar Ahora</button>
                    </h3>
                </div>
                    ...
                    <div class="cards-container">
                        <div class="row list-stamp mb-4" id="cardStamp-70" style="position: relative;">
                            ...
                            <div class="col-md-6">
                                ...
                                <p><b><i class="fas fa-user"></i> Provider</b>: <span class="badge badge-success">Telemedicine Provider</span> </p>
                        ...
                        <div class="row list-stamp mb-4" id="cardStamp-70" style="position: relative;">
                            ...
                            <div class="col-md-6">
                                <p><b><i class="fas fa-user"></i> Fecha</b>: 10:44pm a las 20 mayo 2002</p>
                                <p><b><i class="fas fa-user"></i> Clinica</b>: <span class="badge badge-success">Telemedicine Provider</span></p>
                                 <p><b><i class="fas fa-user"></i> Paciente</b>: <span >Julio Rafael Melgar</span> </p>
                                <p class="text-success"><b><i class="fas fa-check-double"></i> Estado</b>:Finalizada <img src="<?= base_url("assets/images/check.png"); ?>" width="30" alt=""></p>
                                <p>
                                    <button class="btn-button btn-button-light">
                        ...
                        <div class="row list-stamp mb-4" id="cardStamp-70" style="position: relative;">
                            <div class="col-md-6">
                                <p><b><i class="fas fa-user"></i> Fecha</b>: 10:44pm a las 20 mayo 2002</p>
                                <p><b><i class="fas fa-user"></i> Clinica</b>: <span class="badge badge-success">Rubymed </span></p>
                                 <p><b><i class="fas fa-user"></i> Paciente</b>: <span >Julio Rafael Melgar</span> </p>
                                <p class="text-success"><b><i class="fas fa-check-double"></i> Estado</b>:Finalizada <img src="<?= base_url("assets/images/check.png"); ?>" width="30" alt=""></p>
                                <p>
                                    <button class="btn-button btn-button-light">
