...
<?php } ?>
        ...
        $("#ticket-table").appTable({
            ...
            columns: [
                ...
                {title: '<?php echo app_lang("clinic") ?>', "class": "w15p clinic-column", order_by: "client"},
            ...
            onInitComplete: function () {
                $("#ticket-table").on("click", ".clinic-column a", function (event) {
                    event.preventDefault(); // Evita la redirección del enlace
                    event.stopPropagation(); // Evita que el evento se propague a la tabla
                });
            }
        });
