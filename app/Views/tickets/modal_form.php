    ...
    <div class="modal-body clearfix">
        <div class="container-fluid">
            ...
            <?php } else if (!$model_info->creator_email) { ?>
                <div class="form-group">
                    <div class="row">
                        <label for="client_id" class=" col-md-3"><?php echo app_lang('clinic'); ?></label>
                        <div class="col-md-9">

                            <select class="select2 validate-hidden" name="client_id" id='client_id'>
                                <?php foreach ($clinic_dropdown as $id => $name) { ?>
                            ...
                            //echo form_dropdown("client_id", $clinic_dropdown, array($model_info->client_id), "class='select2 validate-hidden' id='client_id' data-rule-required='true', data-msg-required='" . app_lang('field_required') . "'");
                            ?>
                        </div>
                    </div>
                </div>
