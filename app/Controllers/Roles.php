...
class Roles extends Security_Controller
{
    ...
    function permissions($role_id)
    {
        if ($role_id) {
            ...
            $view_data['deposit'] = get_array_value($permissions, "can_access_deposit_report");
            $view_data['lead'] = get_array_value($permissions, "lead");
            $view_data['camera'] = get_array_value($permissions, "camera_permission");
            $view_data['clock'] = get_array_value($permissions, "clock_permission");
            ...
            $view_data['daily_permission'] = get_array_value($permissions, "daily_permission");
            $view_data['event_permission'] = get_array_value($permissions, "event_permission");
            $view_data['task_permission'] = get_array_value($permissions, "task_permission");

            $view_data['note_permission'] = get_array_value($permissions, "note_permission");
            $view_data['team_permission'] = get_array_value($permissions, "team_permission");
            $view_data['report_permission'] = get_array_value($permissions, "report_permission");

            $view_data['file_permission'] = get_array_value($permissions, "file_permission");
            $view_data['support_permission'] = get_array_value($permissions, "support_permission");
            $view_data['pending_permission'] = get_array_value($permissions, "pending_permission");
            //$view_data['daily_chart_permission'] = get_array_value($permissions, "daily_chart_permission");
            $view_data['bills_project_permission'] = get_array_value($permissions, "bills_project_permission");

            $view_data['can_see_price_list'] = get_array_value($permissions, "can_see_price_list");
            $view_data['can_create_price_list'] = get_array_value($permissions, "can_create_price_list");
            $view_data['credit_card'] = get_array_value($permissions, "credit_card_permission");
            $view_data['excuse_permission'] = get_array_value($permissions, "excuse_permission");

            $view_data['stamp_permission'] = get_array_value($permissions, "stamp_permission");
            $view_data['stamp_permission_v1'] = get_array_value($permissions, "stamp_permission_v1");
            $view_data['vsee_permission'] = get_array_value($permissions, "vsee_permission");
            $view_data['directory_permission'] = get_array_value($permissions, "directory_permission");
            $view_data['home_service_permission'] = get_array_value($permissions, "home_service_permission");
    ...
    function save_permissions()
    {
        ...
        $deposit = $this->request->getPost('deposit_permission');
        $lead = $this->request->getPost('lead_permission');
        $camera = $this->request->getPost('camera_permission');
        $clock = $this->request->getPost('clock_permission');
        $excuse = $this->request->getPost('excuse_permission');
        $ticket = $this->request->getPost('ticket_permission');
        $vsee = $this->request->getPost('vsee_permission');
        $credit_card_permission = $this->request->getPost('credit_card_permission');
        $home_service_permission = $this->request->getPost('home_service_permission');
        $ticket_specific = "";
        if ($ticket === "specific") {
        ...
        $daily_permission = $this->request->getPost("daily_permission");
        $event_permission = $this->request->getPost("event_permission");
        $task_permission = $this->request->getPost("task_permission");

        $note_permission = $this->request->getPost("note_permission");
        $team_permission = $this->request->getPost("team_permission");
        $report_permission = $this->request->getPost("report_permission");
        //$stamp_permission = $this->request->getPost("stamp_permission");
        $stamp_permission_v1 = $this->request->getPost("stamp_permission_v1");
        $directory_permission = $this->request->getPost("directory_permission");

        $file_permission = $this->request->getPost("file_permission");
        $support_permission = $this->request->getPost("support_permission");
        $pending_permission = $this->request->getPost("pending_permission");
        //$daily_chart_permission = $this->request->getPost("daily_chart_permission");
        $bills_project_permission = $this->request->getPost("bills_project_permission");
        ...
        $can_see_price_list = $this->request->getPost('can_see_price_list');
        $can_create_price_list = $this->request->getPost('can_create_price_list');
        ...
        $permissions = array(
            ...
            "bills_project_permission" => $bills_project_permission,
            "can_see_price_list" => $can_see_price_list,
            "can_create_price_list" => $can_create_price_list,
            "can_access_deposit_report" => $deposit,
            'credit_card_permission' => $credit_card_permission,
              'vsee_permission' => $vsee,
            "camera_permission" => $camera,
            'excuse_permission' => $excuse,
            'stamp_permission' => $stamp_permission_v1,
            'stamp_permission_v1' => $stamp_permission_v1,
            'directory_permission' => $directory_permission,
            'clock_permission' => $clock,
            'home_service_permission' => $home_service_permission
        );
