...
if (!function_exists('get_notification_config')) {
    ...
    function get_notification_config($event = "", $key = "", $info_options = array())
    {
        ...
        $events = array(
            ...
            "excuse_created" => array(
                "notify_to" => array("user"), // Notifica al provider y al usuario (puedes ajustar estos roles según tu lógica)
                "info" => function($options) {
                    // Redirige a la lista de excusas
                    return array("url" => get_uri("excuse"));
                }
            ),
            "excuse_approved" => array(
                "notify_to" => array("provider", "user"),
                "info" => function($options) {
                    return array("url" => get_uri("excuse"));
                }
            ),
